...
<div class="bg-white rounded-lg shadow-md p-6">
    <h2 class="text-2xl font-bold text-gray-800 mb-6">
        <i class="fas fa-comments text-pink-500 mr-2"></i>Conversas
    </h2>
    ...
    @else
        <div class="text-center py-12">
            ...
            <h3 class="text-xl font-semibold text-gray-600 mb-2">Nenhuma conversa ainda</h3>
            <p class="text-gray-500 mb-6">Comece a conversar com seus matches!</p>
            <a href="{{ route('matching.matches') }}" 
               class="bg-pink-500 text-white px-6 py-3 rounded-lg hover:bg-pink-600 transition duration-200">
                <i class="fas fa-heart mr-2"></i>Ver Meus Matches
            </a>
        </div>
    @endif
</div>
