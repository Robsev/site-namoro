...
@section('title', __('messages.location.title'))
...
<div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Header -->
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-gray-900">{{ __('messages.location.title') }}</h1>
            <p class="mt-2 text-gray-600">{{ __('messages.location.description') }}</p>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                <h2 class="text-xl font-semibold text-gray-900 mb-4">
                    ...
                    {{ __('messages.location.map') }}
                </h2>
                <div id="map" class="w-full h-96 rounded-lg border border-gray-200"></div>
                <div class="mt-4 text-sm text-gray-600">
                    <p><strong>{{ __('messages.location.current_location') }}:</strong> <span id="map-address">
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <div class="mb-6">
                    <button id="detectLocationBtn" 
                        ...
                        {{ __('messages.location.detect_current') }}
                    </button>
                ...
                <div class="mb-6">
                    <label class="block text-sm font-medium text-gray-700 mb-2">
                        {{ __('messages.location.search_city') }}
                    </label>
                    <div class="relative">
                        <input type="text" 
                               id="locationSearch" 
                               placeholder="{{ __('messages.location.city_placeholder') }}"
                ...
                <div class="space-y-4">
                    <h3 class="text-sm font-medium text-gray-700">{{ __('messages.location.info_title') }}</h3>
                    
                    <form id="manualLocationForm" action="{{ route('location.update') }}" method="POST">
                        @csrf
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <label class="block text-xs font-medium text-gray-700 mb-1">{{ __('messages.location.latitude') }}</label>
                                <input type="number" 
                                       name="latitude" 
                                       id="latitude"
                                       step="any" 
                            ...
                            <div>
                                <label class="block text-xs font-medium text-gray-700 mb-1">{{ __('messages.location.longitude') }}</label>
                                <input type="number" 
                                       name="longitude" 
                                       id="longitude"
                                       step="any" 
                        ...
                        <div class="grid grid-cols-2 gap-4 mt-6">
                            ...
                            <button type="button" 
                                ...
                                {{ __('messages.location.clear_location') }}
                            </button>
                        </div>
                    </form>
                </div>
